...
import Pumpjack from './scenes/oilPumpJack/pumpjack.gltf';
import Moon from './scenes/moon.jpeg';
import MoonTexture from './scenes/moonTexture.jpeg';
...
export class oilProjectGraphics{
    ...
    _init(){
        ...
        const oilWellLoader = new GLTFLoader(loadingManager); oilWellLoader.load(Pumpjack, function( gltf ) {
        ...
        const moonTexture = new THREE.TextureLoader(loadingManager).load(Moon);
        const normalTexture = new THREE.TextureLoader(loadingManager).load(MoonTexture);
        ...
        function addPipe(pipeDataList){
          ...
          const font = textLoader.load(
            '/Heebo Black_Regular.json',
          );
          textLoader.load('/Heebo Black_Regular.json', function ( font ){
          ...
          subTextLoader.load('/Heebo Black_Regular.json', function ( font ){
